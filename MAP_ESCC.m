        ...
        controlcd=fullfile(mainfolder, 'ESCCHCindividual');%Set the directory for EV lists of individual healthy controls.
        combinedcd=fullfile(mainfolder, 'ESCCCombinedFiles');%Set the directory for combined EV lists.
        cd(combinedcd);
        fstruct=dir('*.txt');
