        ...
        mainfolder=cd;
        samplecd=fullfile(mainfolder, 'ADindividual');%Set the directory for EV lists of individual patients.
        controlcd=fullfile(mainfolder, 'ADHCindividual');%Set the directory for EV lists of individual healthy controls.
        combinedcd=fullfile(mainfolder, 'ADCombinedFiles');%Set the directory for combined EV lists.
        cd(combinedcd);
        fstruct=dir('*.txt');
